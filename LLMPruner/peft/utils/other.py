...
def prepare_model_for_int8_training(
    ...
    print("loaded_in_8bit", loaded_in_8bit) # False
    print("use_gradient_checkpointing", use_gradient_checkpointing) # True
    print("hasattr(model, output_embedding_layer_name)", hasattr(model, output_embedding_layer_name)) # True
