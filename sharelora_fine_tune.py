...
from peft import get_peft_model, ShareLoraConfig
...
def main(args):
    ...
    config = ShareLoraConfig(
        r_local=args.local_r,
        r_intra=args.intra_r,
        r_inter=args.inter_r,
        share_mode=args.share_mode,
        kron_share_size=args.kron_share_size,
        gate_share_size=args.gate_share_size,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="./tune_log/share_eq_r8", help='output directory')
    ...
    # Lora Configuration
    parser.add_argument('--local_r', type=int, default=8, help='lora r')
    parser.add_argument('--inter_r', type=int, default=8, help='lora r')
    parser.add_argument('--intra_r', type=int, default=8, help='lora r')
    parser.add_argument('--lora_alpha', type=int, default=16, help='lora alpha')
    parser.add_argument('--lora_dropout', type=float, default=0.05, help='lora dropout')
    parser.add_argument('--share_mode', type=str, default="kron", help='lora dropout')
    parser.add_argument('--kron_share_size', type=int, default=256, help='lora dropout')
    parser.add_argument('--gate_share_size', type=int, default=1024, help='lora dropout')

    # parser.add_argument('--lora_target_modules', type=str,
    #                     default="q_proj,k_proj,v_proj,up_proj,down_proj", help='lora target modules')
    # parser.add_argument('--lora_target_modules', type=str,
    #                     default="q_proj,k_proj,v_proj,o_proj", help='lora target modules')
    parser.add_argument('--lora_target_modules', type=str,
                        default="gate_proj,up_proj,down_proj", help='lora target modules')
