...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.SHARELORA: ShareLoraModel,
    PeftType.BASELINESHARELORA: BaselineShareLoraModel,
    PeftType.TIEDLORA: TiedLoraModel
}
    ...
    **Attributes**:
    ...
    def save_pretrained(
        ...
        def save_mutated_as_lora(peft_config, path_initial_model_for_weight_conversion, output_state_dict, kwargs):
            ...
            if not any(
                    str(peft_config.init_lora_weights).lower().startswith(prefix) for prefix in
                    ["pissa", "olora", "true"]
            ):
                warnings.warn(
