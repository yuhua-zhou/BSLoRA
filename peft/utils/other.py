...
def prepare_model_for_kbit_training(model, use_gradient_checkpointing=True, gradient_checkpointing_kwargs=None):
    ...
    # print("loaded_in_kbit", loaded_in_kbit) # False
    ...
    # print("is_gptq_quantized", is_gptq_quantized) # False
    # print("is_aqlm_quantized", is_aqlm_quantized) # False
    # print("is_eetq_quantized", is_eetq_quantized) # False
    # print("is_hqq_quantized", is_hqq_quantized) # False
