...
from .tuners import (
    ...
    VeraModel,
    XLoraConfig,
    BaselineShareLoraConfig,
    BaselineShareLoraModel,
    TiedLoraConfig,
    TiedLoraModel
)
...
PEFT_TYPE_TO_CONFIG_MAPPING: dict[str, type[PeftConfig]] = {
    ...
    "HRA": HRAConfig,
    "VBLORA": VBLoRAConfig,
    "SHARELORA": ShareLoraConfig,
    "BASELINESHARELORA": BaselineShareLoraConfig,
    "TIEDLORA":TiedLoraConfig
}
...
PEFT_TYPE_TO_TUNER_MAPPING: dict[str, type[BaseTuner]] = {
    ...
    "HRA": HRAModel,
    "VBLORA": VBLoRAModel,
    "SHARELORA": ShareLoraModel,
    "BASELINESHARELORA": BaselineShareLoraModel,
    "TIEDLORA":TiedLoraModel
}
